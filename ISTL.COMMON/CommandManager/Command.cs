...
namespace ISTL.COMMON.CommandManager
{
    public class Command
    {
        ...
        public void AddExecuteHandler(ExecuteHandler handlerExecute)
        {
            OnExecute += handlerExecute;
        }

        public void RemoveExecuteHandler(ExecuteHandler handlerExecute)
        {
            OnExecute -= handlerExecute;
        }

        public void AddUpdateHandler(ExecuteHandler handlerUpdate)
        {
            OnExecute += handlerUpdate;
        }

        public void RemoveUpdateHandler(ExecuteHandler handlerUpdate)
        {
            OnExecute -= handlerUpdate;
        }
        ...
        public class CommandInstanceList : System.Collections.CollectionBase
        {
            ...
            protected override void OnRemoveComplete(System.Int32 index,
                                                        System.Object value)
            {
                command.Manager.GetCommandExecutor(value).InstanceRemoved(value);
            }
        }
    }
}
