/******************************************************************************
 * 
 * Ref: http://msdn.microsoft.com/en-us/magazine/cc188928.aspx
 *      http://i.msdn.microsoft.com/cc188928.fig02(en-us).gif
 * 
Dictionary
-------------------------------------------------------------------------------
...
public class CommandManager : System.ComponentModel.Component
{
    ...
    public CommandManager()
    {
        ...
        RegisterCommandExecutor("System.Windows.Forms.Button",
                                    new ButtonCommandExecutor());
    }
