...
{
    public partial class ServiceSettingsUserControl : ViewUserControl
    {
        public ServiceSettingsUserControl()
        {
            InitializeComponent();
        }
        ...
        {
            ((ServiceSettingsController)controller).BattalionSettings();
        }

        private void btnServiceSettings_Click(object sender, EventArgs e)
        {
            ((ServiceSettingsController)controller).ServiceSettings();
        }
    }
}
